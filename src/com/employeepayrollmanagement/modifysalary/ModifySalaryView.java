...
public class ModifySalaryView implements ModifySalaryViewCallBack{
	...
	public void employeeModifySalary(Employee employee) {
		System.out.println("You have chosen Emp ID:"+employee.getEmpID()+" Emp Name"+employee.getFirst_name()+" "+employee.getLast_name());
	...
	public void addIncentive(Employee employee) {
		...
		modifySalaryController.addIncentive(employee,incentive,LocalDate.now().getDayOfMonth(),LocalDate.now().getDayOfYear());
	}
	@Override
	...
	public void salaryUpdated(Salary salaryOfEmployee) {
		System.out.println("Employee ID"+salaryOfEmployee.getEmpID()+"\t\tEmployee Name:"+salaryOfEmployee.getFirst_name());
